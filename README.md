<div align="center">
  ...
  <p>
    <img src="https://img.shields.io/badge/Node.js-v22.x-339933?style=for-the-badge&logo=node.js&logoColor=white" alt="Node.js" />
    <img src="https://img.shields.io/badge/React-v19.x-61DAFB?style=for-the-badge&logo=react&logoColor=black" alt="React" />
    <img src="https://img.shields.io/badge/Express-v5.x-000000?style=for-the-badge&logo=express&logoColor=white" alt="Express" />
    <img src="https://img.shields.io/badge/MySQL-8.x-005C84?style=for-the-badge&logo=mysql&logoColor=white" alt="MySQL" />
  ...
  <p>
    ...
    <img src="https://img.shields.io/badge/Architecture-Clean_Layered-blue?style=flat-square" alt="Architecture" />
...
graph TD
    ...
    subgraph API_Gateway [Backend - Express 5]
        API_Client --> Auth[Auth Middleware - JWT]
        Auth --> Routes[Express Routers]
        Routes --> Controllers[Controllers - Req/Res]
    end

    subgraph Business_Logic [Service Layer]
        Controllers --> Services[Services - Business Logic]
        Services --> AI[AI Agents - Gemini/OpenAI]
        Services --> Socket[Socket.IO - Realtime]
    end

    subgraph Data_Layer [Persistence]
        Services --> ORM[Sequelize ORM]
        ORM --> MySQL[(MySQL 8.0)]
        Services --> Cache[(Redis Cache)]
        Services --> Storage[Cloudinary - Images]
    end

    subgraph External_APIs [Third Party]
        Services --> VNPay[VNPay Gateway]
        Services --> PayPal[PayPal API]
        Services --> Mail[Nodemailer]
    end
```
