  ...
  if (startPage > 1) {
    items.push(
      <button
        ...
        className="size-10 flex items-center justify-center rounded-xl bg-white dark:bg-dark-surface border border-slate-200 dark:border-dark-border text-slate-600 dark:text-dark-text-secondary hover:bg-slate-50 dark:hover:bg-dark-bg hover:text-primary transition-all disabled:opacity-50 shadow-sm"
      >
        <FiChevronsLeft />
      </button>
    );
  ...
  for (let i = startPage; i <= endPage; i++) {
    ...
    items.push(
      <button
        ...
        className={`size-10 flex items-center justify-center rounded-xl font-bold transition-all shadow-sm ${
          isActive 
