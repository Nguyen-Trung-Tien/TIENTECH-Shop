    ...
    const mock = [
      {
        ...
        name: "Nguyễn Văn A",
        role: "Kỹ sư phần mềm",
        text: "Trải nghiệm mua sắm tuyệt vời. Sản phẩm chính hãng, đóng gói cẩn thận và giao hàng thần tốc. Sẽ tiếp tục ủng hộ Tien-Tech Shop trong tương lai.",
        avatar: image1,
        rating: 5
      },
      {
    ...
    <section className="py-20 bg-surface-50 overflow-hidden">
      <div className="container-custom">
        <div className="flex flex-col items-center mb-16 text-center">
          ...
          >
            Khách Hàng Nói Gì Về <span className="text-primary">Tien-Tech</span>
          </motion.h3>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h6 className="font-bold text-surface-900 leading-none">{t.name}</h6>
                    <p className="text-[11px] font-bold text-primary uppercase tracking-widest mt-1.5">{t.role}</p>
                  </div>
                </div>
              </div>
            </motion.div>
