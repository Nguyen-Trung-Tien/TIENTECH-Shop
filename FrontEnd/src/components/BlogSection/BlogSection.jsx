    ...
    const mock = [
      {
        ...
        excerpt:
          "Hướng dẫn chi tiết cách chọn laptop, điện thoại phù hợp với từng nhu cầu học tập và làm việc.",
      ...
      },
      {
        ...
        excerpt:
          "Những bí quyết giúp thiết bị công nghệ của bạn luôn bền bỉ và ổn định trong mọi điều kiện thời tiết.",
      ...
      },
      {
        ...
        excerpt:
          "Khám phá tương lai của AI, thiết bị đeo thông minh và hệ sinh thái công nghệ mới nhất.",
          ...
          {posts.map((p, index) => (
            ...
            >
              ...
              <div className="p-6 flex flex-col flex-1">
                <p className="text-[11px] font-bold text-surface-400 mb-3">
                  {p.date}
                </p>
