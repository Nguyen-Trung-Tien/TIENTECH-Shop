      ...
      <div className="container-custom relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            >
              Tien-Tech <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-indigo-400">Shop</span>
              <br />
              <span className="text-2xl md:text-4xl font-light text-slate-400">Định nghĩa lại trải nghiệm công nghệ</span>
            </motion.h1>
            ...
            >
              Khám phá hệ sinh thái sản phẩm công nghệ chính hãng từ Laptop, Smartphone đến linh kiện PC cao cấp. Cam kết giá tốt nhất thị trường cùng chính sách bảo hành 1:1.
            </motion.p>
            ...
            >
               <div className="flex flex-col items-center lg:items-start">
                  <p className="text-white font-bold text-xl leading-none">50k+</p>
                  <p className="text-[10px] uppercase font-bold tracking-widest text-slate-500">Khách hàng</p>
               </div>
               <div className="w-[1px] h-8 bg-slate-800 hidden sm:block"></div>
               <div className="flex flex-col items-center lg:items-start">
                  <p className="text-white font-bold text-xl leading-none">100%</p>
                  <p className="text-[10px] uppercase font-bold tracking-widest text-slate-500">Chính hãng</p>
               </div>
               <div className="w-[1px] h-8 bg-slate-800 hidden sm:block"></div>
               <div className="flex flex-col items-center lg:items-start">
                  <p className="text-white font-bold text-xl leading-none">24/7</p>
                  <p className="text-[10px] uppercase font-bold tracking-widest text-slate-500">Hỗ trợ</p>
               </div>
            </motion.div>
          </div>
          ...
          >
            <div className="relative z-10 p-8 rounded-[40px] bg-gradient-to-br from-white/10 to-transparent border border-white/10 backdrop-blur-sm">
                ...
                >
                  ...
                  <div>
                    <p className="text-[10px] font-bold text-slate-400 uppercase">Flash Sale</p>
                    <p className="text-sm font-black text-slate-900 leading-tight">Giảm tới 50%</p>
                  </div>
                </motion.div>
            </div>
