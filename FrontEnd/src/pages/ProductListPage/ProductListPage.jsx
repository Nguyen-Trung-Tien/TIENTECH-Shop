                  ...
                  >
                    ...
                    >
                      <div className="p-6 border-b border-slate-100 flex items-center justify-between">
                         <h2 className="text-lg font-black uppercase tracking-tight">Bộ lọc</h2>
                         <button onClick={() => setShowMobileFilter(false)} className="w-10 h-10 rounded-xl bg-slate-50 flex items-center justify-center text-slate-400">
                           <FiGrid />
                         </button>
                      </div>
           ...
           <div className="lg:col-span-9">
              ...
              {loading && products.length === 0 ? (
                ...
                <div className="bg-white rounded-[32px] border-2 border-dashed border-slate-200 p-24 text-center">
                   ...
                   <h3 className="text-xl font-black text-slate-900 mb-2 uppercase italic">Không tìm thấy</h3>
                   <p className="text-slate-400 font-medium text-sm">Thử thay đổi bộ lọc để tìm kiếm kết quả khác.</p>
                </div>
              ) : (
