    ...
    <div className="space-y-8 p-4 md:p-8 max-w-[1600px] mx-auto">
      ...
      <div className="bg-white dark:bg-dark-surface p-4 rounded-[32px] border border-slate-100 dark:border-dark-border shadow-soft flex flex-wrap items-center gap-4">
        ...
        <button
          ...
          className="h-12 px-8 bg-indigo-600 text-white rounded-2xl text-xs font-black uppercase tracking-widest hover:bg-slate-800 dark:hover:bg-indigo-700 transition-all shadow-lg shadow-indigo-600/20"
        >
          Lọc dữ liệu
        </button>
      </div>
        ...
        {selectedPayment && (
          <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4">
            ...
            <Motion.div
              ...
              className="relative w-full max-w-2xl bg-white dark:bg-dark-surface rounded-[40px] shadow-2xl overflow-hidden border border-slate-100 dark:border-dark-border"
            >
              ...
              <div className="p-8 bg-slate-50 dark:bg-dark-bg flex justify-end gap-3">
